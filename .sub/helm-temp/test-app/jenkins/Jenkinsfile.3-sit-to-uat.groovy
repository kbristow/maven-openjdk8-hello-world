...
subatomicTeamName = "testing-helm-template"
subatomicProjectName = "helm-temp"
subatomicAppName = "test-app"
...
def deploy(environment, imageTag, cluster) {
    ...
    sh "helm template ${subatomicHomeFolder}/charts/ --values=${subatomicHomeFolder}/charts/values-${environment}.yaml --values=${subatomicHomeFolder}/charts/values.yaml"
