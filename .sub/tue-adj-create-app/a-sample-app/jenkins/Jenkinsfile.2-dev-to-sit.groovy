...
subatomicTeamName = "kieran-test"
subatomicProjectName = "tue-adj-create-app"
subatomicAppName = "a-sample-app"
subatomicHomeFolder = ".sub/${subatomicProjectName}/${subatomicAppName}"
hasIngress = true

nonprodClusters = [
    [
        name: "subatomic-test-uat-nonprod-270",
        fqdn: "subatomic-test-uat.270-nonprod.caas.absa.co.za",
        kubeconfigConfigmapName: "subatomic-test-uat-nonprod-270-kubeconfig"
    ], 
    [
        name: "subatomic-test-uat-nonprod-sdc",
        fqdn: "subatomic-test-uat.sdc-nonprod.caas.absa.co.za",
        kubeconfigConfigmapName: "subatomic-test-uat-nonprod-sdc-kubeconfig"
    ]
]
...
prodClusters = [
    [
        name: "subatomic-test-uat-prod-270",
        fqdn: "subatomic-test-uat.270-nonprod.caas.absa.co.za",
        kubeconfigConfigmapName: "subatomic-test-uat-prod-270-kubeconfig"
    ], 
    [
        name: "subatomic-test-uat-prod-sdc",
        fqdn: "subatomic-test-uat.sdc-nonprod.caas.absa.co.za",
        kubeconfigConfigmapName: "subatomic-test-uat-prod-sdc-kubeconfig"
    ]
]
